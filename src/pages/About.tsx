        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="glass-card rounded-2xl p-8 lg:p-10 bg-black">
            <div className="space-y-4 text-muted-foreground">
              ...
              <p>Beyond the corporate world, I care deeply about my community. I served over six years on the Hampton Planning Commission and serve as the Vice-Chair on the Hampton Economic Development Authority and the, helping guide strategic investments and growth in my hometown.</p>
              <p>
