        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="glass-card rounded-2xl p-8 lg:p-10 bg-inherit">
            <div className="space-y-4 text-muted-foreground">
              ...
              <p>My journey has taken me through some incredible roles—Enterprise Business Technology Consultant at Marathon Consulting, Senior Director of Engineering at Elevance Health, Managing Director at Integrated Business Systems, COO at Solvern Innovations, Director of Information Technology at Norfolk State University, and Staff Director at the FDIC. Along the way, I've led teams of over 130 developers, managed multi-million dollar budgets, and delivered more than 100 software projects. But what I'm most proud of is the relationships I've built and the real impact we've made together.</p>
              <p>I'm a lifelong learner—earning my Master of Public Administration and B.S. in Computer Information Systems from Strayer University. And yes, I've collected a few certifications along the way: PMP, SAFe® Practice Consultant, Release Train Engineer, DevOps Practitioner, Professional Scrum Master, COBIT 5, ITIL, and completed the USDA Executive Leadership Program. They've all helped me bring structure and best practices to the chaos that can be enterprise technology.</p>
              <p>Beyond the corporate world, I care deeply about my community. I served over six years on the Hampton Planning Commission and serve as the Vice-Chair on the Hampton Economic Development Authority helping guide strategic investments and growth in my hometown.</p>
              <p>
