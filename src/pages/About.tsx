        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="glass-card rounded-2xl p-8 lg:p-10">
            <div className="space-y-4 text-muted-foreground">
              ...
              <p>
                My journey has taken me through some incredible roles—Senior Director of Engineering at Elevance Health, Managing Director at Integrated Business Systems, COO at Solvern Innovations, and Staff Director at the FDIC. Along the way, I've led teams of over 130 developers, managed multi-million dollar budgets, and delivered more than 100 software projects. But what I'm most proud of is the relationships I've built and the real impact we've made together.
              </p>
              <p>
